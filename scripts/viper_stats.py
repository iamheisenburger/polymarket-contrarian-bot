#!/usr/bin/env python3
"""
VIPER Stats — Trade analytics for Precision Sniper strategy.
...
Run: python3 scripts/viper_stats.py
"""
import csv
import glob
import os
...
DEFAULT_CSVS = ["data/viper_5m.csv", "data/viper_15m.csv"]
