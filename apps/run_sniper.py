...
def main():
    ...
    parser.add_argument(
        "--fok-tolerance", type=float, default=0.04,
    ...
    parser.add_argument(
        ...
        help="Number of FOK retry steps after initial rejection (default: 3). "
             "Each step adds +1c. With tolerance=0.04 and retries=3: tries +4c, +5c, +6c, +7c."
    )
    parser.add_argument(
